...
## EC2 Hibernate
When stopping or terminating an EC2 instance, the data on disk is kept intact but any in-memory data or data stored in the EBS volumes are lost.
...
EC2 Hibernate is a state where the OS of the instance has not stopped but is suspended, meaning any volatile data is preserved and booting is 