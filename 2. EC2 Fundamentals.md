...
- For convertible reserved instances, you can change the EC2 instance type, family, OS, scope, and tenancy, with a 66% discount compared to On-Demand
## EC2 Savings Plans
- Get a discount based on long-term usage (up to 72% like RIs)
- Commit to a certain type of usage ($10/hr for 1 or 3 years)
- Usage beyond EC2 Savings Plans is billed at the On-Demand price
- Locked to a specific instance family and AWS Region
- Flexible instance size and OS
## EC2 Spot Instances
- Discount of up to 90% compared to On-Demand
- Instances that can be "lost" at any point in time if your max price is less that the current spot price
- The most cost-efficient instances AWS offers
...
## EC2 Dedicated Hosts
- A physical server with EC2 instance capacity fully dedicated to your usage
- Allows you to address compliance requirements and use your existing server-bound software licenses (per-socket, per-core, etc.)
- Can buy On-Demand (pay per second)
- Can buy Reserved (1 or 3 years with discount depending on Upfront payment)
...
- No control over instance placement on hardware
- Basically a Dedicated Host but with EC2 Instances
![[2.1 EC2 Pricing Comparison.png]]
# Spot Instances & Spot Fleet
## Spot Instance
- Can get a discount of up to 90% compared to On-Demand
- You define your Max Spot Price and get the instance only while the current spot price is below your maximum. You are bidding for hours of usage.
...
- You can also block reserve spot instances for a specified time frame (1 to 6 hours), although this only reduces the chances that your instance will be reclaimed
- Good for batch jobs, data analysis, or workloads that are resilient to failures
- Not good for critical jobs or databases
![[2.2 EC2 Terminating a Spot Instance.png]]
## Spot Fleet
...
- Allocation Strategies:
	...
	- diversified: distribute launches from all pools
	- capacityOptimized: launch from pool with optimal capacity for number of instances
	- priceCapacityOptimized: launch from the cheapest pool with the highest available capacity